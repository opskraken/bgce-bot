# Roadmap: bgce-bot MVP & Beyond

## Overview
- **MVP Goal**: Launch a working prototype to validate automate project discussions via chatbot.
- **Launch Timeline**: Q1 2026.
- **Success Metrics**: 50 issues linked, 10 active channels.
...
|----------|--------------|-------------|--------|----------------------------|--------------|
| **Must-Have (MVP Core)** | [Feature 1] | [TBD: Core feature for bgce-bot. Why: Enables automate project discussions via chatbot.] | Not Started | 5 | None |
...
## How to Contribute
- Propose features via [GitHub Issues](https://github.com/NesoHQ/bgce-bot/issues/new?template=feature_request.md).
